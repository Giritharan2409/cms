...
const NAV_ITEM_MAP = {
  ...
  'Admission Dashboard': { to: '/admission-dashboard', icon: 'analytics' },
  'Admission Status': { to: '/admission-status', icon: 'timeline' },
  'Staff Admission': { to: '/staff-admission', icon: 'people' },
  'Enrollment': { to: '/enrollment', icon: 'how_to_reg' },
  'Semester Fees': { to: '/semester-fees', icon: 'receipt_long' },
